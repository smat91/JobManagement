...
namespace PresentationLayer.MVVM.ViewModel
{
    class NewOrderViewModel : ObservableObject
    {
        ...
        public NewOrderViewModel(ItemConnection itemConnection, CustomerConnection customerConnection, OrderConnection orderConnection)
        {
            ...
            ItemList = itemConnection_.GetAll();

            CustomerList = customerConnection_.GetAll();
